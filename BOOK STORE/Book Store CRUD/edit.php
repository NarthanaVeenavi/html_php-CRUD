<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=='GET'){
    ...
    $sql = "update crud2 set name='$name', author='$author', description='$description', isbn='$isbn' where id='$id'";
    $result = $conn->query($sql);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" class="fw-bold">
 ...
 <label> ISBN: </label>
 <input type="text" name="isbn" value="<?php echo $isbn; ?>" class="form-control"> <br>
